		...
		<div class="row">
			<div class="col-md-4 order-md-2 mb-4">
				...
				<form class="card p-2">
					<div class="input-group">
						<input type="text" class="form-control @error('email') is-invalid @enderror" placeholder="Promo code" />
			...
			<div class="col-md-8 order-md-1 card p-3">
				...
				<div class="mt-2 d-none" id="showCustomerLogin">
					<form class="needs-validation" id="formValidation" method="POST" action="{{route('customer.loginFromCheckout')}}" novalidate>
						@csrf
				...
				<div class="mt-2" id="showcustomerRegistration">
					<form class="needs-validation" id="formValidation" method="POST" action="{{route('customer.register')}}" novalidate>
						@csrf
